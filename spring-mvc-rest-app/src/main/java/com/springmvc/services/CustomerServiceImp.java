...
import com.springmvc.controllers.v1.CustomerController;
...
public class CustomerServiceImp implements CustomerService {
    ...
    public CustomerServiceImp(CustomerRepository customerRepository, @Qualifier("customerMapperImp") CustomerMapper customerMapper) {
